...
### Endpoints
An OpenAPI generated overview of REST endpoints can be seen by starting the backend and go to `http://localhost:8000/docs`, or `https://backend.quizzma.no/docs` when the production instance is running. This does not include the websocket endpoint.
