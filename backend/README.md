...
### Endpoints
An OpenAPI generated overview of REST endpoints can be seen by starting the backend and go to `http://localhost:8000/docs`, `https://backend.quizzma.no/docs` or when the production instance is running. This does not include the websocket endpoint.

A screenshot is included below for convenience:
![alt text](../resources/images/endpoints.png)
