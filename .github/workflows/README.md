...
| Secret   | `VITE_CLERK_PUBLISHABLE_KEY`| Clerk public key           |
| Secret   | `CLERK_SECRET_KEY`          | Clerk secret key             |
...
| Secret   | `VITE_CLERK_PUBLISHABLE_KEY`| Clerk publishable key (frontend use)         |
| Secret   | `CLERK_SECRET_KEY`          | Clerk secret key                             |
